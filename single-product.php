...
// Ensure the global $product is loaded properly
global $product;
...
if (!$product || !$product->exists()) {
    ...
    get_footer();
    exit; // Stop processing if no valid product is found
}
            ...
            <div class="mt-6 sm:mt-8 lg:mt-0">
                ...
                <div class="mt-4 sm:items-center sm:gap-4 sm:flex">
                    <p class="text-2xl font-extrabold text-gray-900 sm:text-3xl dark:text-white">
                        <?php echo wc_price($product->get_price()); // Safely get the price ?>
                    </p>
                </div>

                <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                    <!-- Add to favorites and Add to cart buttons -->
                    <a href="#" class="flex items-center justify-center py-2.5 px-5 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600" role="button">
                    ...
                    <!-- Add to cart button -->
                    <a href="#" class="text-black mt-4 sm:mt-0 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 flex items-center justify-center">
...
<section><div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <?php
